...
import com.swjd.modules.system.dao.ActionDao;
import com.swjd.modules.system.entity.Action;
import com.swjd.modules.system.entity.ActionType;
import com.swjd.modules.system.entity.ChangeItem;
import com.swjd.util.DiffUtil;
...
public class DatalogAspect {
    ...
    @Pointcut("execution(public * com.swjd.modules.system.service.impl.*.update*(..))")
    public void save(){

    }

    @Pointcut("execution(public * com.swjd.modules.system.dao.*.*delete*(..))")
    public void delete(){
